...
class HeaderBand(ttk.Frame):
    ...
    def __init__(self, parent: tk.Widget) -> None:
        ...
        # Settings Button
        self.settings_btn = ttk.Label(self, text="⚙", font=("Segoe UI", 12), cursor="hand2")
        self.settings_btn.grid(row=0, column=3, padx=(8, 8), pady=8, sticky="e")

        # Logout Power Button
        self.logout_btn = ttk.Label(self, text="⏻", font=("Segoe UI", 12), cursor="hand2")
        self.logout_btn.grid(row=0, column=4, padx=(0, 16), pady=8, sticky="e")
